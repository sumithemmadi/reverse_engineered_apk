  ...
  private boolean C(int paramInt1, int paramInt2) {
    ...
    for (j = 0; j < i; j++) {
      ...
      if (view.getVisibility() != 8) {
        ...
        if (k == f.topPanel) {
          view1 = view;
        } else if (k == f.buttonPanel) {
          view2 = view;
        } else if (k == f.contentPanel || k == f.customPanel) {
          if (view3 != null)
            return false; 
          view3 = view;
        } else {
    ...
    for (i2 = 0; i4 < i; i2 = n) {
      ...
      n = i2;
      if (view.getVisibility() != 8)
        n = Math.max(i2, view.getMeasuredWidth()); 
      i4++;
    } 
    ...
    while (paramInt3 < n) {
      ...
      if (view != null) {
        ...
        if (view.getVisibility() != 8) {
          ...
          paramInt4 = e.b(paramInt4, w.C((View)this)) & 0x7;
          if (paramInt4 != 1) {
            if (paramInt4 != 5) {
            ...
            i4 = (j - i - m - i2) / 2 + i + layoutParams.leftMargin;
            paramInt4 = layoutParams.rightMargin;
            paramInt4 = i4 - paramInt4;
          } 
          i4 = paramInt1;
          ...
          A(view, paramInt4, paramInt1, i2, i3);
...
/* Location:              /home/sumith/decompile/test/classes-dex2jar.jar!/androidx/appcompat/widget/AlertDialogLayout.class
