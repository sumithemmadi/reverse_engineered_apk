...
public final class UnifiedNativeAdView extends FrameLayout {
  ...
  private final void c(String paramString, View paramView) {
    try {
  ...
  public final void setAdChoicesView(AdChoicesView paramAdChoicesView) {
    c("3011", (View)paramAdChoicesView);
  }
  ...
  public final void setMediaView(MediaView paramMediaView) {
    c("3010", (View)paramMediaView);
    if (paramMediaView != null) {
      paramMediaView.a(new k(this));
      paramMediaView.b(new l(this));
    } 
  }
  
  public final void setNativeAd(g paramg) {
    try {
      this.c.d1((a)paramg.k());
      return;
    } catch (RemoteException remoteException) {
...
/* Location:              /home/sumith/decompile/test/classes-dex2jar.jar!/com/google/android/gms/ads/formats/UnifiedNativeAdView.class
