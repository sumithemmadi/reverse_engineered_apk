...
public class OverlayGuideActivity extends BaseThemeActivity implements View.OnClickListener {
  ...
  private void R() {
    ((TextView)findViewById(2131298043)).setTypeface(this.t);
    ((TextView)findViewById(2131298042)).setTypeface(this.t);
    ((TextView)findViewById(2131298041)).setTypeface(this.t);
  ...
  class a implements Animation.AnimationListener {
    a(OverlayGuideActivity this$0) {}
    
    public void onAnimationEnd(Animation param1Animation) {
      OverlayGuideActivity.O(this.a).startAnimation(OverlayGuideActivity.N(this.a));
    }
  ...
  class b implements Animation.AnimationListener {
    b(OverlayGuideActivity this$0) {}
    
    public void onAnimationEnd(Animation param1Animation) {
      OverlayGuideActivity.O(this.a).setVisibility(4);
      OverlayGuideActivity.P(this.a).setChecked(true);
      OverlayGuideActivity.O(this.a).postDelayed(new a(this), 1000L);
    }
    ...
    class a implements Runnable {
      a(OverlayGuideActivity.b this$0) {}
      
      public void run() {
        OverlayGuideActivity.P(this.b.a).setChecked(false);
        OverlayGuideActivity.O(this.b.a).setVisibility(0);
        OverlayGuideActivity.O(this.b.a).startAnimation(OverlayGuideActivity.Q(this.b.a));
      }
    }
  }
...
/* Location:              /home/sumith/decompile/test/classes-dex2jar.jar!/com/allinone/callerid/mvc/controller/permission/OverlayGuideActivity.class
