  ...
  private static class a extends AsyncTask<String, Void, String> {
    ...
    protected String a(String... param1VarArgs) {
      ...
      try {
        ...
        param1VarArgs = arrayOfString;
        hashMap.put("cc", p.d(this.b).getCountry_code());
        param1VarArgs = arrayOfString;
        ...
        if (bool) {
          ...
          param1VarArgs = arrayOfString;
          d0.a("checkactivity", stringBuilder.toString());
        } 
        param1VarArgs = arrayOfString;
        String str = com.allinone.callerid.j.a.b("https://app.show-caller.com/api/v1/cheact.php", hashMap);
        str1 = str;
        if (d0.a) {
          str1 = str;
          StringBuilder stringBuilder = new StringBuilder();
        ...
        if (str != null) {
          ...
          if (!"".equals(str)) {
            ...
            if (jSONObject.getInt("status") == 1) {
              ...
              str1 = str;
              int j = jSONObject.getInt("activity_count");
              str1 = str;
              ...
              if (eZSearchContacts == null) {
                ...
                str1 = str;
                eZSearchContacts.setActivity_count(String.valueOf(j));
                str1 = str;
                ...
                str1 = str;
                str3.setIs_activity(i);
                str1 = str;
                str3.setActivity_count(String.valueOf(j));
                str1 = str;
                f.b().e((EZSearchContacts)str3, new String[] { "is_activity", "activity_count" });
                str3 = str;
              } 
            } 
          } 
...
/* Location:              /home/sumith/decompile/test/classes-dex2jar.jar!/com/allinone/callerid/i/a/g/b.class
